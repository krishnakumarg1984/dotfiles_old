...
" Plug 'AndrewRadev/sideways.vim'  " SidewaysLeft & SidewaysRight, to move item under the cursor left or right
...
" Plug 'tpope/vim-endwise',{'for':['ruby','sh','zsh','vb','vbnet','aspvbs','vim','c','cpp','lua','elixir','haskell','matlab','crystal','xdefaults','objc','htmldjango','htmljinja','jinja.html','snippets']}
" Plug 'plasticboy/vim-markdown'
" Plug 'mzlogin/vim-markdown-toc'
" Plug 'Valloric/MatchTagAlways',{'for':['html','xml']}
" Plug 'AndrewRadev/splitjoin.vim',{'for':['ruby','eruby','perl','python','rust','php','javascript','html','xml','handlebars','css','scss','less','yaml','lua','vim','tex','c','cpp','elixir']}
